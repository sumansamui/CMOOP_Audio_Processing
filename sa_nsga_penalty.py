...
# Assuming the h5 file is in the correct path
# Update this path if necessary
loaded_data = load_from_hdf5('/home/22EC1102/soumen/data/bird_sound/mel_spec.h5', mfcc_directory)
...
print("Original labels:", original_labels[:10]) # Original labels: ['sonspa' 'eursta' 'others' 'eursta' 'houspa' 'spotow' 'houspa' 'norcar' 'redcro' 'houspa']
...
###############
# --- NSGA-II and Model Hyperparameters ---
EPOCHS = 300
BATCH_SIZE = 64
PATIENCE = 5
...
POP_SIZE = 15
MAX_GEN = 30
INFILL_PERCENT = 0.2 # Percentage of offspring to evaluate with the true function each generation
CROSSOVER_PROB = 0.9
MUTATION_PROB = 0.2
EPSILON = 1e-6  # Small value for crowding distance ties

# Constraint thresholds
MIN_ACCURACY = 0.75 #0.90
...
def initialize_population(pop_size):
    """Generates the initial random population of hyperparameter sets."""
    population = []
...
if __name__ == "__main__":
    ...
    output_dir = "nsga2_surrogate_results"
